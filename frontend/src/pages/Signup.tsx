  ...
  return (
    <div className="mx-auto  rounded-md flex  w-fit items-center mt-16 ">
      <motion.div
        ...
        className=" h-full my-auto border md:border-none shadowGreen p-4 rounded-md"
      >
          ...
          <div className="my-3 text-sm sm:text-base md:text-md lg:text-lg">
            ...
            <div className="flex items-center gap-1 relative">
              <input
                ...
                className="outline-none focus:rounded-md bg-[#05101c] my-2 p-2 w-full border-b-2  focus:bg-white focus:text-black py-2"
                name="password"
                onChange={handleInputChange}
              />
              <div
